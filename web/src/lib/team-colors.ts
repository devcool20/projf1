const TEAM_COLORS: Record<string, { accent: string; bg: string }> = {
  ...
  "Red Bull":           { accent: "#3671C6", bg: "rgba(54,113,198,0.12)" },
  ...
  "RB":                 { accent: "#6692ff", bg: "rgba(102,146,255,0.12)" },
  "Haas F1 Team":       { accent: "#b6babd", bg: "rgba(182,186,189,0.12)" },
  "Haas":               { accent: "#b6babd", bg: "rgba(182,186,189,0.12)" },
  "Kick Sauber":        { accent: "#52e252", bg: "rgba(82,226,82,0.12)" },
